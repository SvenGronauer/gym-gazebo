...
class OpenManipulatorv0Env(gazebo_env.GazeboEnv):
    def __init__(self):
        # Launch the simulation with the given launchfile name
        gazebo_env.GazeboEnv.__init__(self, "open_manipulator_gazebo.launch")
        ...
        # self._sub = rospy.Subscriber('/cart_pole/joint_states', JointState,
